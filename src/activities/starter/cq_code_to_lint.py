"""
    ...
    This is a module that contains a function that will be linted in activity
    3.6
"""
...
def incorrect_spacing_between_functions():
    print('This function has incorrect spacing between it and the ')
    print('function above')


def incorrect_spacing_between_functions_1():
